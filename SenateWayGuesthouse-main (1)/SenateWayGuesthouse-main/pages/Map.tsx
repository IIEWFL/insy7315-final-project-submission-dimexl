...
//Accuweather.com. (2025). AccuWeather Developer | Personal Weather API | AccuWeather Developer. [online] Available at: https://developer.accuweather.com/home.
...
//Kwon, M.K. (2020). OpenWeatherMap API call ‘icon’ not working. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/62729254/openweathermap-api-call-icon-not-working.
...
//Starkman, E. (n.d.). The UV Index Explained. [online] WebMD. Available at: https://www.webmd.com/skin-problems-and-treatments/uv-index-overview.
...
export function Map() {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      //Gps coordinates (2018). GPS coordinates, latitude and longitude with Google Maps. [online] Gps-coordinates.net. Available at: https://www.gps-coordinates.net/.
  ...
  useEffect(() => {
    const fetchWeather = async () => {
      try {
        ...
        //Netlify, I. (2020). How to create proxy on Netlify functions? [online] Netlify Support Forums. Available at: https://answers.netlify.com/t/how-to-create-proxy-on-netlify-functions/22183.
