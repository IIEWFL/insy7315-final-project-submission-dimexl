...
export function Contact() {
   ...
   // Sir, M. (2023). Save the current state of a form (with properties). [online] Stack Overflow. Available at: https://stackoverflow.com/questions/76563160/save-the-current-state-of-a-form-with-properties. =====
...
// MDN Web Docs. (2024). Sending form data - Learn web development | MDN. [online] Available at: https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Sending_and_retrieving_form_data. =====
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //Prabhat (2019). Send Email Directly From JavaScript using EmailJS. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/58791656/send-email-directly-from-javascript-using-emailjs.
