...
// Static list of room data
//saghafi, faeze (2018). android - How to get simple list from db using Room? [online] Stack Overflow. Available at: https://stackoverflow.com/questions/52847714/android-how-to-get-simple-list-from-db-using-room.
const rooms: Room[] = [
  {
    id: 1,
...
export function Rooms() {
  //Petty-Saphon, M. (2020). Filtering using react hooks - not setting state within use effect. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/59952799/filtering-using-react-hooks-not-setting-state-within-use-effect.
 ...
 // Filtering logic based on user-selected filters
 //Paul (2013). How to Filter result in MVC 4 based on user. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/18060445/how-to-filter-result-in-mvc-4-based-on-user.
