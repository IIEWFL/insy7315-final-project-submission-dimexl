...
//W3schools.com. (2025). W3Schools.com. [online] Available at: https://www.w3schools.com/typescript/typescript_aliases_and_interfaces.php.
interface Review {
  id: string;
  name: string;
  rating: number;
 ...
 // State for storing reviews and form data
 //Gale, B. (2012). Guidance for storing state in a database for a web application. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/12281993/guidance-for-storing-state-in-a-database-for-a-web-application.
 // GeeksforGeeks (2024). How to Design a Relational Database for Customer Reviews and Ratings Platform. [online] GeeksforGeeks. Available at: https://www.geeksforgeeks.org/sql/how-to-design-a-relational-database-for-customer-reviews-and-ratings-platform/.
...
export function Reviews() {
  ...
  //Yurty123 (2022). Android Studio - listing reviews from Firebase. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/73608194/android-studio-listing-reviews-from-firebase.
  useEffect(() => {
    ...
    const fetchReviews = () => {
      onValue(reviewsRef, (snapshot) => {
        ...
        if (data) {
          ...
          //Schober, D. (2019). Converting Firebase object(s) to an array. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/58252471/converting-firebase-objects-to-an-array.
    ...
    //Ant's (2016). Remove Event Listener On Unmount React. [online] Stack Overflow. Available at: https://stackoverflow.com/questions/38564080/remove-event-listener-on-unmount-react.
    return () => {
      off(reviewsRef);
    };
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Push to Firebase
      //Firebase (2019). Saving Data  |  Firebase Realtime Database. [online] Firebase. Available at: https://firebase.google.com/docs/database/admin/save-data.
