...
// Stack Overflow. (2019). Create a chatbot with predefined question and answers in python? [online] Available at: https://stackoverflow.com/questions/58340614/create-a-chatbot-with-predefined-question-and-answers-in-python.=====
...
// Google for Developers. (n.d.). Function calling | Google AI for Developers. [online] Available at: https://ai.google.dev/gemini-api/docs/function-calling. =====
  const getBotResponse = async (userMessage: string): Promise<string> => {
    try {
      ...
      //petekemp (2022). A best practice guide to fallback responses - EBM. [online] EBM. Available at: https://ebm.ai/a-best-practice-guide-to-fallback-responses/.
      if (!joinedText) {
 ...
 // Google for Developers. (2025). Send a message using the Google Chat API. [online] Available at: https://developers.google.com/workspace/chat/create-messages. =====
