...
//EmailJS Pte Ltd. (2025) Dynamic variables in templates. Available at: https://www.emailjs.com/docs/user-guide/dynamic-variables-templates/
...
export function Bookings() {
  ...
  const sendBookingNotification = async (booking: Booking) => {
    ...
    try {
      ...
      //EmailJS Pte Ltd. (2025) Connecting email services. Available at: https://www.emailjs.com/docs/user-guide/connecting-email-services/
      await emailjs.send(
        serviceId,
        templateConfirmed,
        {
