...
exports.handler = async (event, context) => {
  ...
  //Stack Overflow (2021) How to load API keys from .env file successfully. Available at: https://stackoverflow.com/questions/68195644/how-to-load-api-keys-from-env-file-successfully/
